...
#[Route('/atelierDashboard')]
final class AtelierbackController extends AbstractController
{
    #[Route(name: 'app_atelierDashboard_index', methods: ['GET'])]
   ...
   public function index(Request $request, AtelierRepository $atelierRepository, PaginatorInterface $paginator): Response
    {
        ...
        return $this->render('atelierDashboard/index.html.twig', [
    ...
    #[Route('/new', name: 'app_atelierDashboard_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $em): Response
    {
        ...
        return $this->render('atelierDashboard/new.html.twig', [
            'atelier' => $atelier,
            'form' => $form,
        ]);
    }
    ...
    #[Route('/{id}', name: 'app_atelierDashboard_show', methods: ['GET'])]
    public function show(Atelier $atelier): Response
    {
        return $this->render('atelierDashboard/show.html.twig', [
            'atelier' => $atelier,
        ]);
    }
    ...
    public function edit(Request $request, Atelier $atelier, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_atelierDashboard_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('atelierDashboard/edit.html.twig', [
            'atelier' => $atelier,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_atelierDashboard_delete', methods: ['POST'])]
