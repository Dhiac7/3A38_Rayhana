...
#[Route('/reservationDashboard')]
final class ReservationbackController extends AbstractController
{    #[Route(name: 'app_reservationDashboard_index', methods: ['GET'])]
    ...
    public function index(Request $request, ReservationRepository $reservationRepository, PaginatorInterface $paginator): Response
    {
        ...
        return $this->render('reservationDashboard/index.html.twig', [
            'pagination' => $pagination,
        ]);
        
    }

    #[Route('/new', name: 'app_reservationDashboard_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_reservationDashboard_index', [], Response::HTTP_SEE_OTHER);
        }
