...
#[Route('/dechetDashboard')]
final class DechetbackController extends AbstractController
{
    #[Route(name: 'app_dechetDashboard_index', methods: ['GET'])]
    ...
    public function index(Request $request, DechetRepository $dechetRepository, PaginatorInterface $paginator): Response
    {
        ...
        return $this->render('dechetDashboard/index.html.twig', [
    ...
    #[Route('/new', name: 'app_dechetDashboard_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_dechetDashboard_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('dechetDashboard/new.html.twig', [
            'dechet' => $dechet,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_dechetDashboard_show', methods: ['GET'])]
    public function show(Dechet $dechet): Response
    {
        return $this->render('dechetDashboard/show.html.twig', [
            'dechet' => $dechet,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_dechetDashboard_edit', methods: ['GET', 'POST'])]
