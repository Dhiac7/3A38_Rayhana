 ...
 */
final class Version20250302104743 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vente CHANGE user_id user_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vente CHANGE user_id user_id INT DEFAULT NULL');
    }
}
