 ...
 */
final class Version20250215193711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vente ADD quantite DOUBLE PRECISION NOT NULL, ADD nom VARCHAR(255) NOT NULL, CHANGE transaction_id produit_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vente DROP quantite, DROP nom, CHANGE produit_id transaction_id INT DEFAULT NULL');
