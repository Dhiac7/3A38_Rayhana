 ...
 */
final class Version20250304023034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE atelier (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, description VARCHAR(255) NOT NULL, date_atelier DATE NOT NULL, capacite_max INT NOT NULL, prix DOUBLE PRECISION NOT NULL, statut VARCHAR(100) NOT NULL, role VARCHAR(100) NOT NULL, nbrplacedispo INT DEFAULT NULL, photo VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, start_at DATETIME NOT NULL, end_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE place (id INT AUTO_INCREMENT NOT NULL, atelier_id INT DEFAULT NULL, code VARCHAR(255) NOT NULL, is_available TINYINT(1) NOT NULL, INDEX IDX_741D53CD82E2CF35 (atelier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, place_id INT DEFAULT NULL, atelierid INT NOT NULL, id_user INT NOT NULL, date_reservation DATE NOT NULL, mode_paiement VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, nbr_place INT NOT NULL, role VARCHAR(100) NOT NULL, UNIQUE INDEX UNIQ_42C84955DA6A219 (place_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
