 ...
 */
final class Version20250212144154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vente ADD user_id INT DEFAULT NULL, ADD transaction_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vente DROP user_id, DROP transaction_id');
    }
}
