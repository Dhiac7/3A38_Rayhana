 ...
 */
final class Version20250207165750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE avis (id INT AUTO_INCREMENT NOT NULL, id_avis INT NOT NULL, name_client VARCHAR(255) NOT NULL, date_stock DATE NOT NULL, id_produit INT NOT NULL, rate DOUBLE PRECISION NOT NULL, commentaire VARCHAR(255) NOT NULL, date DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE dechet (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(100) NOT NULL, quantite DOUBLE PRECISION NOT NULL, date_production DATE NOT NULL, statut VARCHAR(255) NOT NULL, date_expiration DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE inspection (id INT AUTO_INCREMENT NOT NULL, id_inspection INT NOT NULL, date_inspection DATE NOT NULL, type_inspection VARCHAR(255) NOT NULL, inspecteur_id INT NOT NULL, resultat VARCHAR(255) NOT NULL, note INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, quantite DOUBLE PRECISION NOT NULL, prix_vente DOUBLE PRECISION NOT NULL, quantite_vendues DOUBLE PRECISION NOT NULL, en_promotion TINYINT(1) NOT NULL, pourcentage_promo INT NOT NULL, date_debut_promo DATETIME NOT NULL, date_fin_promo DATETIME NOT NULL, quantite_retourne DOUBLE PRECISION DEFAULT NULL, date_retour DATE DEFAULT NULL, statut VARCHAR(255) NOT NULL, raison_retour VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stock (id INT AUTO_INCREMENT NOT NULL, quantite INT NOT NULL, date_stock DATE NOT NULL, quantite_initiale DOUBLE PRECISION NOT NULL, quantite_utilise DOUBLE PRECISION NOT NULL, date_expiration DATE NOT NULL, lieu VARCHAR(255) NOT NULL, conditionn VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
