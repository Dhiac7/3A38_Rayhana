 ...
 */
final class Version20250215121911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE transactionfinancier (id INT AUTO_INCREMENT NOT NULL, datetransaction DATETIME NOT NULL, montant DOUBLE PRECISION NOT NULL, description VARCHAR(255) NOT NULL, type VARCHAR(50) NOT NULL, nbrheure INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vente (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, transaction_id INT DEFAULT NULL, produit_id INT DEFAULT NULL, date DATETIME NOT NULL, prix DOUBLE PRECISION NOT NULL, methodepayement VARCHAR(255) NOT NULL, quantite DOUBLE PRECISION NOT NULL, nom VARCHAR(255) NOT NULL, INDEX IDX_888A2A4CA76ED395 (user_id), UNIQUE INDEX UNIQ_888A2A4C2FC0CB0F (transaction_id), INDEX IDX_888A2A4CF347EFB (produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
